...
export class AnimationBuilder<P extends number = number, M extends number = number, L extends number = number, R extends number = number, V extends number = number>
  ...
  private _trajectory: Trajectory<P, M, L> | ((context: ItemContext<P, M, L, R, V>) => Trajectory<P, M, L>) = {}
   ...
   */
  trajectory(config: Trajectory<P, M, L> | ((context: ItemContext<P, M, L, R, V>) => Trajectory<P, M, L>)): this {
   ...
   */
  get trajectoryConfig(): Trajectory<P, M, L> | ((context: ItemContext<P, M, L, R, V>) => Trajectory<P, M, L>) {
 ...
 */
export function isRule<P extends number = number, M extends number = number, L extends number = number, R extends number = number, V extends number = number>(ruleId: R): AnimationPredicate<P, M, L, R, V> {
