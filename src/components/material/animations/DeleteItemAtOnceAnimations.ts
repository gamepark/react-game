...
export class DeleteItemAtOnceAnimations<P extends number = number, M extends number = number, L extends number = number, R extends number = number, V extends number = number>
  ...
  getItemAnimation(context: ItemContext<P, M, L, R, V>, animation: Animation<DeleteItemsAtOnce<M>>): Interpolation<Theme> {
